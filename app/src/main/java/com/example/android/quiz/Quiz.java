...
public class Quiz extends AppCompatActivity {
    ...
    //    In on create function,we get the id's of textview and set all the questions.
    @Override
    ...
    //    This functions is called when user clicks submit button in Quiz layout.
//    It checks answer of all the questions,calculates total score and displays the result in Toast message.
...
//  Calculates the total correct answers.
        for (int i = 0; i < ans.length; i++)
            score += ans[i];
        String result = null;
        if (score == 0) {
            result = getString(R.string.poor);
            result = result + score + getString(R.string.points);
            ...
            result = getString(R.string.awesome);
